...
//		
		...
		if(play)
		{
			// draw player 1
			if(player1up)
				player1=new ImageIcon("up.png");	
			else if(player1down)
				player1=new ImageIcon("bot.png");
			else if(player1right)
				player1=new ImageIcon("right.png");
			else if(player1left)
				player1=new ImageIcon("left.png");
				
			player1.paintIcon(this, g, player1X, player1Y);
			
			// draw player 2
			if(player2up)
				player2=new ImageIcon("dogup-removebg-preview.png");	
			else if(player2down)
				player2=new ImageIcon("dogbot-removebg-preview.png");
			else if(player2right)
				player2=new ImageIcon("dogright-removebg-preview.png");
			else if(player2left)
				player2=new ImageIcon("dogleft-removebg-preview.png");
	...
	private class Player1Listener implements KeyListener
	{
		...
		public void keyPressed(KeyEvent e) {	
			...
			if(e.getKeyCode()== KeyEvent.VK_W)
			{
				...
				if(!(player1Y < 50 )) {
					if (player1Y-50 == player2Y && player1X == player2X ) {
						int temp = player1Y;
						player1Y = player2Y;
						player2Y = temp;
			...
			if(e.getKeyCode()== KeyEvent.VK_A)
			{
				...
				System.out.println(player2X);
				if(!(player1X < 50)) {
					if (player1X-50 == player2X && player1Y==player2Y ) {
						int temp = player1X;
						player1X = player2X;
						player2X = temp;
						System.out.println("masuk1");
